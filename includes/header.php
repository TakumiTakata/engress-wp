<header class="l-header">
    <div class="l-header__inner">
      ...
      <a href="#" class="l-header__button c-header-button  c-header-button--inquiry u-dn--sp">お問い合わせ</a>
        ...
        <div class="c-hamburger__contents js-ham-contents">
          <div class="c-hamburger__inner">
            <ul class="c-hamburger__nav">
              <li class="c-hamburger__menu-item c-hamburger__nav-item"><a href="">ホーム</a></li>
              <li class="c-hamburger__menu-item c-hamburger__nav-item"><a href="">お知らせ</a></li>
              <li class="c-hamburger__menu-item c-hamburger__nav-item"><a href="">ブログ</a></li>
              <li class="c-hamburger__menu-item c-hamburger__nav-item"><a href="">コース・料金</a></li>
            </ul>
            <a href="#" class="c-hamburger__menu-item c-hamburger__menu-button c-header-button  c-header-button--request">資料請求</a>
            <a href="#" class="c-hamburger__menu-item c-hamburger__menu-button c-header-button  c-header-button--inquiry">お問い合わせ</a>
          </div>
        </div>
      </div>
    </div>
